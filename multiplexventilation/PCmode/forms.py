...
class CandidatePatientForm(FlaskForm):
    ...
    E2 = FloatField('Elastance (cmH2O/L)', validators = [DataRequired(), NumberRange(min=1, max=50, message="Please enter a number within the range of 1 to 50 ")])
    R2 = FloatField('Resistance (cmH2O.s/L)', validators = [DataRequired(), NumberRange(min=1, max=50, message="Please enter a number within the range of 1 to 50 ")])
    add = SubmitField('Add')
...
class PairingPatientForm(FlaskForm):
    ...
    E = FloatField('Elastance (cmH2O/L)', validators = [DataRequired(), NumberRange(min=1, max=50, message="Please enter a number within the range of 1 to 50 ")])
    R = FloatField('Resistance (cmH2O.s/L)', validators = [DataRequired(), NumberRange(min=1, max=50, message="Please enter a number within the range of 1 to 50 ")])
    Rc = FloatField('Common Resistance (cmH2O.s/L)', validators = [DataRequired()])
